/**
 * Резервные переменные окружения для Firebase
 * Используются только в случае, если они не определены в среде Netlify
 */
module.exports = {
  // Замените эти значения фактическими значениями из Firebase Console
