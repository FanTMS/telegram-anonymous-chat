...
const OnboardingTutorial = ({ onComplete }) => {
    ...
    const [animationKey, setAnimationKey] = useState(0); // Для обновления анимаций при переключении шагов
    ...
    return (
        <div className="tutorial-container" data-step={activeStep} key={animationKey}>
