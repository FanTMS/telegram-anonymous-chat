    ...
    useEffect(() => {
        ...
        const checkBrowserCompatibility = () => {
            ...
            if (typeof window === 'undefined' || typeof document === 'undefined') {
                // Если мы в среде без window или document, считаем что это серверный рендеринг
                // или этап сборки, не выполняем проверку
                return true;
            }
        ...
        // Запускаем проверку только в клиентской среде
        if (typeof window !== 'undefined' && typeof document !== 'undefined') {
