...
const RegistrationForm = ({ onSubmit, telegramUser = null, isDevelopment = false }) => {
    ...
    // Если регистрация завершена, показываем экран успеха
    if (registrationComplete && registeredUser) {
        return <SuccessScreen userData={registeredUser} redirectDelay={2000} />;
    }
