...
import { getGroupMessages, sendGroupMessage, addMessageToGroup } from '../../services/groupService';
...
const GroupMessages = ({ groupId, user, group }) => {
    ...
    const handleSendMessage = async (e) => {
        ...
        try {
            ...
            await addMessageToGroup(groupId, newMessage);
            setInputValue('');
