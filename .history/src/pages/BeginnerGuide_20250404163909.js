...
import WebApp from '@twa-dev/sdk'; // Добавляем импорт WebApp
...
const BeginnerGuide = () => {
    ...
    useEffect(() => {
        try {
            ...
            if (WebApp && typeof WebApp.isExpanded !== 'undefined') {
    ...
    const submitSupportRequest = async () => {
        ...
        try {
            ...
            showToast('Ваше обращение успешно отправлено! Мы ответим вам в ближайшее время.', 'success');
            ...
            showToast('Не удалось отправить запрос. Пожалуйста, попробуйте позже.', 'error');
        } finally {
