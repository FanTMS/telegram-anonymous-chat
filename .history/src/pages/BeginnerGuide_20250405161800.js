...
const BeginnerGuide = () => {
    ...
    // переменная scrollProgress используется для визуализации прогресса прокрутки
        ...
        },
        {
            ...
            content: (
                <motion.div
                    ...
                    className="guide-content-section"
                >
                    <div className="guide-illustration interests-illustration">
                        <span className="guide-emoji">🎯</span>
                    </div>
                    <p>Общие интересы с собеседником - отличная основа для интересной беседы:</p>

                    <div className="guide-interest-examples">
                        {["Музыка", "Кино", "Путешествия", "Книги", "Спорт", "Технологии"].map((interest, index) => (
                            <motion.div
                                key={interest}
                                className="guide-interest-tag"
                    ...
                    <div className="guide-tip">
                        <span className="guide-tip-icon">💡</span>
                        <p>Спросите собеседника об интересах, которые вы указали в профиле. Это повысит вероятность нахождения общей темы для разговора!</p>
                    </div>
                </motion.div>
            )
        }
