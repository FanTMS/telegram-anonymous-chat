...
export const HomeIcon: React.FC<IconProps> = ({ className = '' }) => (
    <svg
        ...
        className={`feather feather-home ${className}`}
    >
...
export const GroupsIcon: React.FC<IconProps> = ({ className = '' }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 24 24"
        fill="none"
...
export const ChatsIcon: React.FC<IconProps> = ({ className = '' }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 24 24"
        fill="none"
...
export const StoreIcon: React.FC<IconProps> = ({ className = '' }) => (
    <svg
        ...
        strokeLinecap="round"
        strokeLinejoin="round"
        className={`feather feather-shopping-bag ${className}`}
    >
