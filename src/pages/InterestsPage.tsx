...
import { Box, Container, Heading, SimpleGrid, Checkbox, Button, Text, useToast, VStack, Flex } from '@chakra-ui/react';
...
const InterestsPage: React.FC = () => {
    ...
    // Добавляем функцию перехода на главную без сохранения
    const handleSkip = () => {
        navigate('/home');
    };
    ...
    return (
        <Container maxW="container.md" py={8}>
            <VStack spacing={8}>
                ...
                <Text>Выберите темы, которые вам интересны для поиска собеседников</Text>
